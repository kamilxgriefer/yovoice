...
class FollowListScreen extends StatelessWidget {
  FollowListScreen({required this.userId, required this.type, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<FollowUser>>(
        stream: stream,
          ...
          if (users.isEmpty) {
            return Center(
              child: Text(
                ...
                style: const TextStyle(color: Color(0xFFB8ADC1), fontSize: 16),
              ),
            );
          }
