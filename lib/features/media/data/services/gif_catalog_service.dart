...
/// The GIPHY half of the picker (ADR-210). `off` whenever this build has no
...
class GifQueryState {
  ...
  /// GIPHY results for [query], searched by the app itself (ADR-210). Always
...
class GifCatalogService extends ChangeNotifier {
  ...
  // -------------------------------------------------------------------------
  // GIPHY (ADR-210, option B): searched here, resolved by the server at send.
  // -------------------------------------------------------------------------
